...
class BukuKegiatanPembangunanService implements BukuAdministrasiInterface
{
    /**
    ...
    {
        throw new \Exception("Method getQuery() not implemented for BukuKegiatanPembangunanService.");
    }
