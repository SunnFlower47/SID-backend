...
class StorePenerimaRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'penduduk_ids.*'         => ['required', 'exists:penduduks,id'],
    ...
    {
        return [
            'penduduk_ids.required'           => 'Penduduk wajib dipilih minimal satu.',
            'penduduk_ids.array'              => 'Format penduduk tidak valid.',
            'penduduk_ids.*.exists'           => 'Penduduk tidak ditemukan.',
