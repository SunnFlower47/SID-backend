...
class TransparansiDesaController extends Controller
{
    ...
    public function apbdes(Request $request)
    {
        ...
        return view('keuangan.dashboard.apbdes', compact('apbdes', 'stats', 'tahunList', 'tahun', 'jenis'));
    }
    ...
    public function proyek(Request $request)
    {
        ...
        return view('keuangan.dashboard.proyek', compact('proyek', 'stats', 'status', 'jenis'));
    }
}
