...
class ComparisonController extends Controller
{
    ...
    private function getMonthData($month)
    {
        ...
        return [
            ...
            'total_kk' => Penduduk::select('nkk')->distinct()->whereBetween('created_at', [$startOfMonth, $endOfMonth])->count(),
    ...
    private function getMonthlyTrends()
    {
        ...
        for ($i = 11; $i >= 0; $i--) {
            ...
            $trends[] = [
                ...
                'kk' => Penduduk::select('nkk')->distinct()->whereBetween('created_at', [$startOfMonth, $endOfMonth])->count(),
    ...
    private function getKKComparison($currentMonth, $lastMonth)
    {
        ...
        $currentKK = Penduduk::select('nkk')->distinct()->whereBetween('created_at', [$currentStart, $currentEnd])->count();
        $lastKK = Penduduk::select('nkk')->distinct()->whereBetween('created_at', [$lastStart, $lastEnd])->count();
