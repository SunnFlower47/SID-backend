...
class AnggaranController extends Controller
{
    ...
    public function createAnggaranTahunan()
    {
        ...
        return view('admin.anggaran.create-tahunan', compact('tahunList', 'currentYear'));
    }
    ...
    public function createPengeluaran(Request $request)
    {
        ...
        return view('admin.anggaran.create-pengeluaran', compact('apbdesList', 'tahunList', 'tahun', 'jenis'));
    }
    ...
    public function createProyek()
    {
        ...
        return view('admin.anggaran.create-proyek', compact('tahunList', 'currentYear', 'apbdesList'));
    }
    ...
    public function historiPengeluaran($id)
    {
        ...
        return view('admin.anggaran.histori-pengeluaran', compact('apbdes'));
    }
    ...
    public function editPengeluaran($id)
    {
        ...
        return view('admin.anggaran.edit-pengeluaran', compact('pengeluaran'));
    }
    ...
    public function editApbdes($id)
    {
        ...
        return view('admin.anggaran.edit-apbdes', compact('apbdes'));
    }
