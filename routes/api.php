...
Route::prefix('v1/admin')->name('admin-api.')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'throttle:100,1'])->group(function () {
        ...
        Route::get('/surat/types', [\App\Http\Controllers\ApiAdminPanel\SuratController::class, 'index']);
        Route::get('/surat/history', [\App\Http\Controllers\ApiAdminPanel\SuratController::class, 'history']);
        Route::get('/surat/statistics', [\App\Http\Controllers\ApiAdminPanel\SuratController::class, 'statistics']);
        Route::post('/surat/{type}', [\App\Http\Controllers\ApiAdminPanel\SuratController::class, 'store']);
        Route::get('/surat/{surat}/download', [\App\Http\Controllers\ApiAdminPanel\SuratController::class, 'download']);
