...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-green-600 via-green-700 to-green-800 rounded-2xl shadow-2xl border-0 p-6 sm:p-8">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h1 class="text-2xl sm:text-3xl font-bold text-white">Tambah Fasilitas Desa</h1>
                <p class="text-green-100 mt-1">Tambah data fasilitas dan infrastruktur desa baru</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg border-0 p-6 sm:p-8">
        <form action="{{ route('fasilitas-desa.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="lg:col-span-2">
                    ...
                    <textarea name="alamat" id="alamat" rows="3" required
                              ...
                              placeholder="Masukkan alamat lengkap fasilitas">{{ old('alamat') }}</textarea>
                    @error('alamat')
                        <p class="mt-2 text-sm text-red-600 flex items-center">
                            <i class="fas fa-exclamation-circle mr-2"></i>
                            {{ $message }}
