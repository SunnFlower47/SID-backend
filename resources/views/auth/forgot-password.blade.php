...
<head>
    ...
    <title>Lupa Password - Desa Cibatu</title>
    <meta name="description" content="Reset Password Admin Panel Sistem Informasi Desa Cibatu, Purwakarta">
    <meta name="keywords" content="reset password, lupa password, desa cibatu, purwakarta">
    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600 text-sm sm:text-base">Masukkan email untuk reset password</p>
            </div>
            <!-- Success Message -->
            @if (session('status'))
                <div class="success-message rounded-xl p-4 mb-6 fade-in">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h3 class="font-semibold text-green-800">Email Terkirim!</h3>
                    ...
                    <div class="pt-4">
                        <button type="submit" class="btn-primary group relative w-full flex justify-center py-4 px-4 border border-transparent text-base font-semibold rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 disabled:opacity-50 disabled:cursor-not-allowed">
                            <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                                <i class="fas fa-paper-plane text-green-500 group-hover:text-green-400 transition-colors"></i>
                            </span>
                            <span class="ml-2">Kirim Link Reset</span>
                        </button>
                    </div>
