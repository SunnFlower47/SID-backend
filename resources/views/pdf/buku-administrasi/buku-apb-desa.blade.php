...
<body>
    ...
    <div class="header" style="text-align: center; margin-bottom: 14px; border-bottom: 2px solid #000; padding-bottom: 8px;">
        <h3 style="margin: 0; padding: 0;">BUKU ANGGARAN PENDAPATAN DAN BELANJA DESA (APB DESA)</h3>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="5" class="text-center">Tidak ada data APB Desa</td>
                </tr>
            @endforelse
        </tbody>
    </table>
