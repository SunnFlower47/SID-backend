...
<head>
    <meta charset="UTF-8">
    <title>Buku Kegiatan Pembangunan</title>
    <style>
...
<body>
    ...
    <div class="header" style="text-align: center; margin-bottom: 14px; border-bottom: 2px solid #000; padding-bottom: 8px;">
        <h3 style="margin: 0; padding: 0;">BUKU KEGIATAN PEMBANGUNAN</h3>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="9" class="text-center">Tidak ada data kegiatan pembangunan</td>
                </tr>
            @endforelse
        </tbody>
    </table>
