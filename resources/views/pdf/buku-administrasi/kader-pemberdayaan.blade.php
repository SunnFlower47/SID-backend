...
<head>
    <meta charset="UTF-8">
    <title>Buku Kader Pemberdayaan - {{ $filters['tahun'] ?? date('Y') }}</title>
    <style>
...
<body>
    <div class="text-center mb-4">
        <div class="font-bold" style="font-size: 14px;">BUKU KADER PENDAMPING PEMBERDAYAAN MASYARAKAT</div>
        <div>(Lampiran B.3 — Permendagri No. 47 Tahun 2016)</div>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
            <tr>
                <td colspan="8" class="text-center">Tidak ada data Kader Pemberdayaan</td>
            </tr>
            @endforelse
        </tbody>
    </table>
