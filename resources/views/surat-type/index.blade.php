                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                <div class="w-10 h-10 rounded-lg bg-gray-100 flex items-center justify-center mr-3">
                                    <i class="{{ $type->icon ?: 'fas fa-file-alt' }} text-{{ $type->color ?: 'gray' }}-600"></i>
                                </div>
                                <div>
                                    <div class="text-sm font-bold text-gray-900">{{ $type->nama }}</div>
                                    <div class="flex items-center space-x-2 mt-1">
                                        <span class="px-2 py-0.5 bg-gray-100 text-gray-700 text-[10px] font-bold rounded uppercase tracking-wider border border-gray-200">
                                            {{ $type->kode ?: $type->id }}
                                        </span>
                                        <span class="text-[10px] text-gray-400 font-mono">{{ $type->id }}</span>
                                    </div>
                                </div>
                            </div>
                        </td>
