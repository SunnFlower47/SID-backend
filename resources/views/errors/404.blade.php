...
<head>
    ...
    <title>404 - Halaman Tidak Ditemukan | Desa Cibatu</title>
...
<body class="bg-gradient-to-br from-green-50 to-green-100 min-h-screen">
    <div class="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8 text-center">
            ...
            <!-- Error Code -->
            <div>
                <h1 class="text-6xl font-bold text-green-600 mb-2">404</h1>
                <h2 class="text-2xl font-semibold text-gray-900 mb-4">Halaman Tidak Ditemukan</h2>
                <p class="text-gray-600 mb-6">{{ $message ?? 'Halaman yang Anda cari tidak ditemukan atau telah dipindahkan.' }}</p>
            </div>
            ...
            <div class="mt-8 p-4 bg-green-50 rounded-lg border border-green-200">
                <p class="text-sm text-green-700">
                    ...
                    Pastikan URL yang Anda masukkan sudah benar atau gunakan menu navigasi.
                </p>
            </div>
        </div>
    </div>
