...
<head>
    ...
    <title>403 - Akses Ditolak | Desa Cibatu</title>
...
<body class="bg-gradient-to-br from-green-50 to-green-100 min-h-screen">
    <div class="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8 text-center">
            ...
            <!-- Error Code -->
            <div>
                <h1 class="text-6xl font-bold text-green-600 mb-2">403</h1>
                <h2 class="text-2xl font-semibold text-gray-900 mb-4">Akses Ditolak</h2>
                <p class="text-gray-600 mb-6">{{ $message ?? 'Anda tidak memiliki izin untuk mengakses halaman ini.' }}</p>
            </div>
