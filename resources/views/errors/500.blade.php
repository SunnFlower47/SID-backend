...
<head>
    ...
    <title>500 - Kesalahan Server | Desa Cibatu</title>
...
<body class="bg-gradient-to-br from-green-50 to-green-100 min-h-screen">
    <div class="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8 text-center">
            ...
            <!-- Error Code -->
            <div>
                <h1 class="text-6xl font-bold text-green-600 mb-2">500</h1>
                <h2 class="text-2xl font-semibold text-gray-900 mb-4">Kesalahan Server</h2>
                <p class="text-gray-600 mb-6">{{ $message ?? 'Terjadi kesalahan pada server. Tim kami telah diberitahu dan sedang memperbaikinya.' }}</p>
            </div>
            ...
            <div class="mt-8 p-4 bg-green-50 rounded-lg border border-green-200">
                <p class="text-sm text-green-700">
                    ...
                    Jika masalah berlanjut, silakan hubungi administrator atau coba lagi nanti.
                </p>
            </div>
        </div>
    </div>
