...
@section('subtitle', 'Buat berita baru untuk website desa')
        ...
        <div class="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-green-50 to-blue-50">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-gray-600">Buat berita atau pengumuman untuk website desa</p>
                </div>
            </div>
        </div>

        <!-- Form -->
        <form action="{{ route('web-desa.berita.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
            @csrf
