...
export default function FasilitasDesaFilters({ filters = {}, jenisOptions = [] }) {
    ...
    const handleApply = () => {
        router.get(route('fasilitas-desa.index'), local, {
            preserveState: true,
            preserveScroll: true,
            replace: true
        });
    ...
    const handleReset = () => {
        ...
        router.get(route('fasilitas-desa.index'));
    };
            ...
            <div className="flex justify-between items-center bg-white p-3 sm:p-4 rounded-2xl sm:rounded-3xl border border-gray-100 shadow-sm transition-all">
                <div className="flex items-center gap-2 sm:gap-4">
                    ...
                    <div>
                        ...
                        <p className="hidden sm:block text-[10px] font-bold text-gray-400 uppercase tracking-widest text-left">Pencarian & Filter Fasilitas Desa</p>
                    </div>
                </div>
                <button
