...
export default function KkFilters({ filters, rtList = [], rwList = [], dusunList = [] }) {
    ...
    const handleApply = () => {
        ...
        // Remove default values or empty strings
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-7 mb-6">
            <div className="flex items-center justify-between gap-3 mb-6">
                <h3 className="text-sm sm:text-base font-black text-gray-950 flex items-center uppercase italic tracking-tighter">
                    ...
                    Konfigurasi Pencarian & Filter KK
                </h3>
                <button 
                    onClick={handleReset}
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    {/* Status Filter */}
                    <div>
                        <label className="block text-[10px] sm:text-xs font-black text-gray-400 uppercase tracking-widest mb-2 ml-1">Status KK</label>
                        <select 
