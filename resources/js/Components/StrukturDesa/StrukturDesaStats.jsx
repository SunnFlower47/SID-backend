...
import { Users, UserCheck, Shield, GraduationCap, MapPin, Home } from 'lucide-react';
import { cn } from '@/lib/utils';

export default function StrukturDesaStats({ stats = {} }) {
    const statCards = [
        {
        ...
        {
            title: 'Kepala Desa & Sekdes',
            value: (stats.kepala_desa || 0) + (stats.sekretaris || 0),
            icon: Shield,
            color: 'amber'
        },
        {
            title: 'Kewilayahan (Dusun/RW/RT)',
            value: (stats.kepala_dusun || 0) + (stats.ketua_rw || 0) + (stats.ketua_rt || 0),
            icon: MapPin,
            color: 'purple'
        }
    ];
    ...
    const colorClasses = {
        ...
        amber: 'border-amber-100 bg-amber-50 text-amber-600 shadow-amber-100/50',
                ...
                return (
                    ...
                    >
                        ...
                        <div className="min-w-0">
                            ...
                            <h3 className="text-xl sm:text-2xl font-black text-gray-900 leading-none text-left italic tracking-tighter">
