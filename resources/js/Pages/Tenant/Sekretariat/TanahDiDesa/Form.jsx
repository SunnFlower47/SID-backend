...
export default function Form({ auth, tanahDiDesa }) {
    ...
    const { data, setData, post, put, processing, errors } = useForm({
        ...
        tanggal_lahir_berdiri: tanahDiDesa?.tanggal_lahir_berdiri ? new Date(tanahDiDesa.tanggal_lahir_berdiri).toISOString().split('T')[0] : '',
        status_kepemilikan: tanahDiDesa?.status_kepemilikan || '',
        tanggal_perolehan: tanahDiDesa?.tanggal_perolehan ? new Date(tanahDiDesa.tanggal_perolehan).toISOString().split('T')[0] : '',
        no_sertifikat: tanahDiDesa?.no_sertifikat || '',
        tanggal_penerbitan_sertifikat: tanahDiDesa?.tanggal_penerbitan_sertifikat ? new Date(tanahDiDesa.tanggal_penerbitan_sertifikat).toISOString().split('T')[0] : '',
