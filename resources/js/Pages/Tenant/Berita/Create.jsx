                    ...
                    <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 text-left text-left">
                        <div className="flex items-center space-x-4 text-left text-left">
                            ...
                            <div className="text-left text-left">
                                <h1 className="text-xl sm:text-3xl font-black text-white tracking-tight uppercase italic leading-none text-left text-left text-left">Terbitkan Konten</h1>
                                <p className="text-green-100 font-bold text-[10px] sm:text-xs uppercase tracking-widest mt-1 opacity-80 italic text-left text-left">Buat Berita, Pengumuman, atau Agenda Desa Baru</p>
                            </div>
                        </div>
                        <Link 
