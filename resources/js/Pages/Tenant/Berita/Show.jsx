                ...
                <div className="bg-gradient-to-r from-green-600 via-green-700 to-green-800 rounded-3xl shadow-xl p-6 sm:p-8 relative overflow-hidden text-left">
                    ...
                    <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 text-left text-left">
                        <div className="flex items-center space-x-4 text-left text-left">
                            <div className="w-12 h-12 sm:w-14 sm:h-14 bg-white/20 backdrop-blur-md rounded-2xl flex items-center justify-center border border-white/20 shadow-inner shrink-0 text-left text-left text-left">
                                <CategoryIcon className="w-6 h-6 sm:w-7 sm:h-7 text-yellow-300 text-left" />
                            </div>
                            <div className="text-left text-left">
                                ...
                                <p className="text-green-100 font-bold text-[10px] sm:text-xs uppercase tracking-widest mt-1 opacity-80 italic text-left text-left">Detail Publikasi & Statistik Informasi</p>
                            </div>
                        </div>
                        <Link 
                        ...
                        >
                            <ArrowLeft className="w-3.5 h-3.5 mr-2 text-left" />
                            KEMBALI
                        </Link>
                    </div>
                </div>
