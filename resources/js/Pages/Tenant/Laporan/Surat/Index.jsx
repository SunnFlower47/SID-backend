    ...
    return (
        <AuthenticatedLayout user={auth.user} title="Laporan Surat">
            ...
            <div className="space-y-6 animate-in fade-in duration-700 pb-20">
                ...
                {/* ── Header ── */}
                <div className="bg-gradient-to-r from-rose-500 via-rose-600 to-rose-700 rounded-3xl shadow-xl p-6 sm:p-8 relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-lg sm:text-2xl font-black text-white tracking-tight uppercase italic leading-none">Laporan Surat</h1>
                                <p className="text-rose-100 font-bold text-[10px] uppercase tracking-widest mt-0.5 opacity-80">Total {totalSurat} pengajuan surat</p>
                            </div>
                        </div>
                        <button onClick={() => setShowFilter(!showFilter)} className={cn('flex items-center px-4 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest border transition-all', showFilter ? 'bg-white text-rose-700' : 'bg-white/10 text-white border-white/10 hover:bg-white/20')}>
